...
const METRIC_CARDS = [
  { title: 'Active Applications', icon: InboxBellFilled },
  { title: 'Onboarded Applicants', icon: RiGroup2Fill },
  { title: 'Docs Under Review', icon: TargetArrow },
  { title: 'Overdue Applications', icon: StackedDots },
] as const;
...
const CHART_TITLES_ROW_2 = ['Delivery trend', 'Top applications by category', 'Application activity trend'] as const;
const CHART_TITLE_ROW_3 = 'Application lodgements';
const CHART_TITLES_ROW_4 = ['Active agents', 'Top applications by country'] as const;
