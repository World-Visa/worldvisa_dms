...
export function LoginForm({
  ...
  const fieldPlaceholder = isAdmin ? "Enter your username" : "name@example.com";
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)}>
        <FieldGroup>
          <Field>
            ...
            <FieldError
              errors={
                (errors as any)[fieldName] ? [(errors as any)[fieldName]] : []
              }
            />
          </Field>
          ...
          <Field>
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-11 bg-blue-600 text-white rounded-md cursor-pointer"
            >
