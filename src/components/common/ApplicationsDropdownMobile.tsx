...
export function ApplicationsDropdownMobile({ onItemClick }: ApplicationsDropdownMobileProps) {
    ...
    <div className="space-y-1">
      ...
      >
        <div className="flex items-center">
          <FileCheck className={cn("h-5 w-5 mr-3", isActive ? "text-blue-600" : "text-gray-400")} />
          All Applications
        </div>
        <ChevronDown 
          className={cn(
