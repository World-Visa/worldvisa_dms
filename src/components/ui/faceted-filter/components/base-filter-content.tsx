...
import { EnterLineIcon } from '@/components/icons/enter-line';
...
export function BaseFilterContent({
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex w-full items-center justify-between rounded-t-md bg-neutral-50 px-1.5 py-1">
        {title && <div className="text-xs font-semibold uppercase leading-[16px] text-neutral-500">{title}</div>}
