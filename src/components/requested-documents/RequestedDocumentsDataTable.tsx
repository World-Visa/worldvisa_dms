    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex items-center gap-2 min-w-[120px]">
            ...
            <span className="text-sm">{row.original.requested_review.requested_by}</span>
          </div>
        ),
        enableSorting: true,
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex items-center gap-2 min-w-[120px]">
            <User className="h-4 w-4 text-gray-400" />
            <span className="text-sm">{row.original.requested_review.requested_to}</span>
          </div>
        ),
        enableSorting: true,
      },
  ...
  if (!documents || documents.length === 0) {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <h3 className="text-sm font-medium text-gray-900 mb-1">{message.title}</h3>
