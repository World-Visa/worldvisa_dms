        ...
        <Table>
          <TableHeader className="bg-gray-50/50">
            <TableRow className="hover:bg-gray-50/50">
              <TableHead className="w-[250px] font-semibold text-gray-700">Document</TableHead>
              <TableHead className="w-[200px] font-semibold text-gray-700">Client Name</TableHead>
              <TableHead className="w-[140px] font-semibold text-gray-700">Requested By</TableHead>
              <TableHead className="w-[140px] font-semibold text-gray-700">Requested To</TableHead>
              <TableHead className="w-[100px] font-semibold text-gray-700">Status</TableHead>
              <TableHead className="w-[150px] font-semibold text-gray-700">Requested</TableHead>
              <TableHead className="text-right w-[100px] font-semibold text-gray-700">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
              ...
              >
                <TableCell>
                  <div className="space-y-1">
                    <p className="text-sm font-semibold text-gray-900 truncate max-w-[220px]" title={document.document_name || document.file_name}>
                ...
                <TableCell>
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500 flex items-center gap-1">
                      ...
                      {document.requested_review.requested_at ? new Date(document.requested_review.requested_at).toLocaleTimeString('en-US', {
                        hour: '2-digit',
                        minute: '2-digit',
                        timeZone: 'UTC'
                      }) : 'Unknown time'}
