...
import { Eye, FileText, CheckCircle, XCircle, Clock, AlertCircle } from 'lucide-react'
...
const DocumentPreview: React.FC<DocumentPreviewProps> = ({ document }) => {
    ...
    const displayFileName = document.file_name?.length > 15
                    ...
                    <TableRow>
                        ...
                        <TableCell className="text-right">
                            {hasDocumentUrl ? (
                                ...
                                <span className="text-xs text-gray-500 hidden sm:inline">N/A</span>
                            )}
                        </TableCell>
                    </TableRow>
                </TableBody>
