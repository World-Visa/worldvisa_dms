...
interface LodgementDeadlineStatsCardProps {
  ...
  onCategoryClick?: (category: 'approaching' | 'overdue' | 'noDeadline' | null) => void;
}
...
export function LodgementDeadlineStatsCard({
  ...
  const handleCategoryClick = (category: 'approaching' | 'overdue' | 'noDeadline' | null) => {
    if (isInteractive) {
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isCardInteractive && "cursor-pointer hover:shadow-md hover:border-primary/50 hover:scale-[1.01]",
