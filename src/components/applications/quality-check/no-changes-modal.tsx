  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md gap-4 p-3">
        <VisuallyHidden>
          <DialogTitle>No applications for quality check</DialogTitle>
          <DialogDescription>There are no applications or spouse skill assessment are ready for quality check right now.</DialogDescription>
        </VisuallyHidden>
        ...
        <div className="">
          <h2 className="text-label-sm text-text-sub">No applications are ready</h2>
          <p className="text-text-soft text-paragraph-xs mt-1">
            You're all caught up! There are no applications or spouse skill assessment are ready for quality check right now.
          </p>
        </div>

        <div className="flex justify-end gap-2">
          <Button onClick={onClose} variant="primary" size="2xs" className='text-xs'>
            Alright
          </Button>
        </div>
      </DialogContent>
