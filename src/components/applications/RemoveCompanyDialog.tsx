      ...
      <AlertDialogContent aria-describedby={descriptionId}>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription id={descriptionId}>
            {hasDocuments ? (
              <>
                You have submitted <strong>{documentCount}</strong> document
                {documentCount !== 1 ? "s" : ""} for{" "}
                <strong>{company.name}</strong>.
                <br />
                <br />
                <span className="text-orange-600 font-medium">
                  Removing this company will delete all associated documents.
                ...
                {isDeleting && (
                  <>
                    ...
                    <span className="text-blue-600 font-medium flex items-center gap-2">
                      ...
                      Deleting documents... Please wait. This dialog cannot be
                      closed during deletion.
                    </span>
                  </>
                )}
              </>
              ...
              <>
                ...
                <br />
                <span className="text-orange-600 font-medium">
                  ⚠️ You must first delete all documents uploaded for this
                  company before removing it.
                </span>
                <br />
                <br />
                If you have uploaded documents for this company, please delete
                them first from the document checklist table.
              </>
            )}
          </AlertDialogDescription>
        </AlertDialogHeader>
