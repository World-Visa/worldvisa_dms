...
export function UploadDocumentsModal({
  ...
  const [selectedDocumentType, setSelectedDocumentType] = useState<string>(
    propSelectedDocumentType || "",
  );
  const [selectedDocumentCategory, setSelectedDocumentCategory] =
    useState<string>(propSelectedDocumentCategory || "");
  ...
  const handleFileSelect = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const validFiles = files.filter((file) => {
      ...
      const isIdentityPhotograph =
        (selectedDocumentCategory === "Identity Documents" ||
          selectedDocumentCategory === "Identity") &&
    ...
    try {
      ...
      try {
        const finalDescription =
          getCompanyDescription(selectedDocumentCategory) || description;
        const finalCategory = getDocumentCategory(
          selectedDocumentType,
          selectedDocumentCategory,
        );
        ...
        if (uploadResult?.data) {
          const apiCategory = getDocumentCategory(
            selectedDocumentType,
            selectedDocumentCategory,
          );
          ...
          <div className="space-y-6">
                ...
                <div className="p-3 bg-muted rounded-lg">
                  ...
                  {selectedDocumentMeta?.allowedDocument !== undefined ? (
                    <p className="text-xs text-muted-foreground mt-1">
                      ...
                      {selectedDocumentMeta.allowedDocument === 1
                        ? ""
                        : "s"}{" "}
                      allowed
                    </p>
            ...
            <div className="space-y-3">
              ...
              <div
                ...
                onClick={() =>
                  selectedDocumentType && fileInputRef.current?.click()
                }
