          ...
          <div className="flex flex-col space-y-1">
              ...
              <div className="ml-6">
                {checklistState === "editing" ? (
                  ...
                  <div className="text-xs text-muted-foreground">
                    ...
                    {item.description.trim().length > 50 && (
                      <button
                        onClick={() => setDescriptionDialogs(prev => ({ ...prev, [itemKey]: true }))}
            ...
            <div className="md:hidden flex flex-wrap gap-1">
              ...
              {(() => {
                ...
                const shouldShowStatus = docCount === 1 && item.isUploaded && item.documentStatus;
                ...
                >
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      {(!item.isUploaded || (item.isUploaded && item.documentStatus !== 'rejected')) && (
                        <DropdownMenuItem
      ...
      {Object.entries(descriptionDialogs).map(([key, isOpen]) => {
        ...
        return (
          <DescriptionDialog
            key={key}
            isOpen={isOpen}
            onClose={() => setDescriptionDialogs(prev => ({ ...prev, [key]: false }))}
