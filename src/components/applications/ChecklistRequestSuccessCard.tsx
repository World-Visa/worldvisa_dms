    ...
    <div className="text-center py-16">
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-10 max-w-lg mx-auto shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Your document checklist request has been successfully submitted. Our
          team will generate a personalized checklist for your visa application
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3 text-left">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Our processing team will review your application and create a
          ...
          <div className="flex items-start space-x-3 text-left">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                You&apos;ll receive your checklist within 24 hours of
                submission.
              </p>
            </div>
          </div>
