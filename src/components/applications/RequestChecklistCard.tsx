...
export function RequestChecklistCard({
  ...
  const { requestChecklist, isLoading, isError } = useChecklistRequest({
    onSuccess: () => {
      if (onRequestSuccess) {
        onRequestSuccess();
      }
    ...
    <div className="text-center py-16">
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-10 max-w-lg mx-auto shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Your document checklist will be generated shortly. This personalized
          checklist will help you track all required documents for your visa
          application process.
        </p>
